...
//       return { valid: false, error: `${field} "${value}" must be in MM/DD/YYYY or MM-DD-YYYY format` };
//     }
...
//       date.getDate() !== day
//     ) {
//       return { valid: false, error: `${field} "${value}" is an invalid date` };
//     }
//   }
...
//     return { valid: false, error: `${field} must have at least ${rule.minLength} characters` };
//   }
//   if (rule.maxLength && String(finalValue).length > rule.maxLength) {
//     return { valid: false, error: `${field} must have at most ${rule.maxLength} characters` };
//   }

//   if (rule.minLength && rule.maxLength && rule.minLength === rule.maxLength) {
//     if (String(finalValue).length !== rule.minLength) {
//       return { valid: false, error: `${field} must have exactly ${rule.minLength} characters` };
//     }
//   }

//   if (rule.enum && !rule.enum.includes(finalValue)) {
//     return { valid: false, error: `${field} must be one of: ${rule.enum.join(", ")}` };
//   }

//   if (rule.pattern && !rule.pattern.test(finalValue)) {
//     return { valid: false, error: `${field} "${finalValue}" is not a valid email` };
//   }
...
// 🔹 Helper para transformar nombres de campos
